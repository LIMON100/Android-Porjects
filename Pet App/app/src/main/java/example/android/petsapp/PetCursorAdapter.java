...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        int nameBreedIndex = cursor.getColumnIndexOrThrow(PetContract.PetEntry.COLUMN_PET_BREED);

        String pName = cursor.getString(nameColumnIndex);
        String pBreed = cursor.getString(nameBreedIndex);

        tvBody.setText(pName);
        tvPriority.setText(String.valueOf(pBreed));
    }
}